##########################
FROM balenalib/jetson-nano-debian:buster-build as build
...
RUN apt-get update && apt-get --no-install-recommends install -y \
   ...
   python3-dev python3-pip time vim file ca-certificates openssl
...
##########################
FROM balenalib/jetson-nano-debian:buster as app_release
